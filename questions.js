...
module.exports = [
    {
        questionNumber: 0,
        scenario: "RB wandered in the wildernes, eventualy coming to a menesing fork in the path.",
    ...
    {
        questionNumber: 5,
        scenario: "There are some slippy spots on the bolder RB slips and dies!!!!!!!!!!!!!!!!!!!!!!!!",
        isEnd: true,
        picture:"rip"
    },
    {
    ...
    },
    {
        ...
        question: "Should he...",
        optionA: "Stay there by the berry tree's forever",
        optionB: "Keep walking toward his home town",
    ...
    {
        questionNumber: 9,
        scenario: "The sound is so loud it kills RB!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!",
        isEnd: true,
        picture:"bang"
    },
    {
